...
<div class="container">
    ...
    <script>
        ...
        //     console.log(selectedDate); //menampilakn tanggal yang di pilih di console
        //     // Kirim permintaan AJAX ke backend untuk mendapatkan jadwal booking yang tersedia
        //     $.ajax({
        //         type: "POST",
        //         url: "/user/waktuBooking",
        //         data: {
        //             [crsfToken]: crsfHash,
        ...
        // //     var selectedDateValue = this.value; // Ambil tanggal yang dipilih

        // //     // Kirim permintaan AJAX ke backend untuk mendapatkan jadwal booking yang tersedia
        // //     $.ajax({
        // //         url: '/user/waktuBooking', // Ganti dengan URL endpoint yang sesuai
        // //         method: 'POST',
        // //         data: {
        // //             [crsfToken]: crsfHash,
        ...
        // //     console.log('Available Times:', availableTimes); // Tambahkan console log untuk memeriksa data yang diterima
        ...
        // //         if (time.id_penyewaan === null) {
        // //             // Jadwal belum terisi, tampilkan checkbox untuk memilih jadwal
        // //             cardHtml += '<input type="checkbox" name="jam[]" id="" value="<?= $itemJadwal->id_jadwal ?>">';
        // //         } else {
        // //             // Jadwal sudah terisi, tampilkan label "Terbooking"
        // //             cardHtml += '<span class="disabled-label">Terbooking</span>';
        // //         }

        // //         // Tambahkan elemen lainnya ke dalam cardHtml
        // //         cardHtml += '<h3 class="text-dark"><span class="mdi mdi-clock-outline" style="font-size: 50px;"></span></h3>' +
